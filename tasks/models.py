...
class Task_detail(models.Model):
    ...
    # assigned_to = models.CharField(max_length=100)                       #reverse relation
                             #media folder's subfolder name "task_asset"
    asset = models.ImageField(upload_to='task_asset',blank=True,null=True,default='task_asset/default.jpeg')
...
class Project(models.Model):
    name = models.CharField(max_length=100)
    description = models.TextField(blank=True,null=True) #can be empty field blank=true
